---
url: /camomilla-core/How to/Use API.md
---
# 🐝 Use API
...
## 🖲️ The model\_api.register decorator

If you need to create a standard api endpoint  you can take advantage of model\_api register decorator.
To use this aproach you need to add the model\_api handler to your project urls.py
