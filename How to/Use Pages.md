---
url: /camomilla-core/How to/Use Pages.md
---
# 📝 Use Pages
...
The data that will be available in the rendering engine should be saved in the template\_data field. This field is a django JSONField. So it will accept any json structure.
